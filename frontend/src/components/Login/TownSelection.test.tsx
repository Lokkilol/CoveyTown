...
import { AppState, GetTokenWithPopupOptions, IdToken, LogoutOptions, PopupConfigOptions, PopupLoginOptions, RedirectLoginOptions, useAuth0 } from '@auth0/auth0-react';
  ...
  describe('Creating and joining towns', () => {
    ...
    describe('Joining existing towns', () => {
      describe('Joining an existing town by ID', () => {
        ...
        //     logout: jest.fn(),
        //     handleRedirectCallback: function (url?: string | undefined): Promise<RedirectLoginResult<any>> {
        //       throw new Error('Function not implemented.');
        //     },
        //     isLoading: false
        //   });
        //   await waitFor(() => {
        //     expect(mockUseAuth0()?.user?.username).toBe(params.userName);
        //   });
